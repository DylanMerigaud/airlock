...
PAPERWORK_RULE_PREFIXES = ("16 CFR", "FTC Act", "FTC Policy Statement", "CAP Code", "ASA ", "registry:brands:not_cleared",
                           "registry:brands:unknown", "registry:faces:no_release", "airlock:provenance:signer-trusted")
