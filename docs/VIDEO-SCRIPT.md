...
[2:12] Provenance lands PASS again (cue provenance_done_3). | "Same clip, same gates."
[2:20] Brand and claim land PASS; the rights row shows "Checking: Video Intelligence" with its calibration line (cue claim_done_3). | "Brand and claim pass again. The rights gate reads the clip one more time, and this time its push reaches Grafana."
